...
class CUpdate:
    ...
    def Update(self, file_path):
        try:
            ...
            first_have_zip_dir = os.path.join(file_dir, file_split[0])

            _logger.debug('Update will del dir = {}\n'.format(first_have_zip_dir)),
            shutil.rmtree(first_have_zip_dir, True)
            cmd = 'unzip -P{89B87785-0C5F-47eb-B7DE-73DD962B0FAE} ' + file_path + ' -d' + file_dir
            ...
            _logger.debug('Update sig.ini base64_sig_str = {} , sig_file_base_name = {}'.format(base64_sig_str,
                                                                                                sig_file_base_name))
